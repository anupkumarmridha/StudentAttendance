...
class addStudentForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = ("user", "phone", "campusEmail", "gender", "profile_pic", "roll", "Department", "Semester")
        widgets = {
            ...
            "campusEmail": forms.EmailInput(
                attrs={"class": "form-control", "placeholder": "Enter Your Campus Email"}
            ),
            ...
            "Semester": forms.Select(
                choices=sem_list, attrs={"class": "form-control"}
            ),
        }
...
class updateStudentForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = ("phone", "campusEmail", "gender", "profile_pic", "roll","Department","Semester")
        widgets = {        
            "phone": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Enter Phone Number"}
            ),
